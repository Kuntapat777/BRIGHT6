...
<body>
    <header>
        <a href="#" class="logo">
            <img src="imges/img100.png" alt="Logo">
        </a>
        <nav>
            <ul class="navlist">
                <li><a href="moisture_selection.html">ค่าความชื้น</a></li>
                <li><a href="moisture.html">กราฟความชื้น</a></li>
                <li><a href="view_data.php">ข้อมูลความชื้น</a></li>
                ...
                <li class="dropdown">     
                    ...
                    <div class="dropdown-content">
                        <a href="profile.php">ข้อมูลผู้ใช้</a>
                        <!-- <a href="#settings">Settings</a> -->
                        <a href="index.html">ออก</a>
                    </div>
                </li>
            </ul>
        </nav>
    ...
    <section class="hero">
        <div class="hero-text" data-aos="fade-right" data-aos-duration="1400">
            <h5>ยินดีต้อนรับ, <?php echo htmlspecialchars($username); ?>!</h5>
            ...
            <h2 data-aos="fade-right" data-aos-duration="1400" data-aos-delay="300">
            ให้เราดูแลต้นไม้ของคุณ
            </h2>
            <p data-aos="fade-right" data-aos-duration="1400" data-aos-delay="300">
            เรามุ่งมั่นที่จะดูแลและบำรุงรักษาต้นไม้ของคุณอย่างดีที่สุด เพื่อให้ต้นไม้เติบโตแข็งแรงและสวยงาม
            </p>
        </div>

        <div class="hero-img" data-aos="zoom-in" data-aos-duration="1400">
            <img src="imges/img9966-Photoroom.png">
        </div>
    </section>
